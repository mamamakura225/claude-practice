...
export const BADGES = [
  ...
  { id: 'practice_again', name: 'また れんしゅうしたね', desc: '2にち きろくした', icon: '🐾' },
  { id: 'streak_3', name: 'れんぞく 3にち', desc: '3にち つづけて れんしゅう', icon: '🔥' },
  { id: 'tempo_all3', name: 'さんしょく テンポ', desc: 'ゆっくり・ふつう・はやい ぜんぶ ためした', icon: '🚦' },
  ...
  { id: 'repertoire_day_5', name: 'きょうは いろいろ', desc: '1にちで 5きょく れんしゅうした', icon: '🎶' },
  { id: 'big_day', name: 'がんばりや', desc: '1にちで 50かい ひいた', icon: '💪' },
  { id: 'song_master_first', name: 'きょくマスター デビュー', desc: '1つの きょくを 50かい ひいた', icon: '🥇' },
  { id: 'month_30', name: '1かげつ がんばった', desc: '30にち きろくした', icon: '🏆' },
  { id: 'streak_30', name: 'れんぞく 30にち', desc: '30にち つづけて れんしゅう', icon: '👑' },
  { id: 'days_50', name: 'きろく 50にち', desc: '50にち きろくした', icon: '🗓️' },
  { id: 'songs_20', name: 'きょく 20きょく', desc: '20きょく れんしゅうした', icon: '🎹' },
  { id: 'comeback', name: 'また はしりだしたね', desc: 'おやすみの あと また れんしゅうを つづけた', icon: '🌤️' },
  { id: 'affinity_max', name: 'ねこと だいの なかよし', desc: 'なかよしレベルが さいこうに なった', icon: '💞' },
