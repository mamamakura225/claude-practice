...
const BUDGETS_KIB = {
  html: 8,
  css: 12,
  js: 79,    // #226:70→72 / #252:72→73 / #238#239:73→75 / #236:75→77 / #237（写真モード＝cat-snapshot.js の canvas 合成＋共有導線）:77→79
  total: 97, // html + css + js の合計（#210:85→88 / #226:88→90 / #238#239:90→92 / #236:92→94 / #237:94→97）
};
