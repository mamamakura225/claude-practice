...
const BUDGETS_KIB = {
  html: 8,
  css: 12,
  js: 77,    // #226 で 70→72、#252 で 72→73、#238/#239 で 73→75。#236（練習カレンダー＝月間ヒートマップの導出・描画・月移動）で 75→77
  total: 94, // html + css + js の合計（#210 で 85→88、#226 で 88→90、#238/#239 で 90→92、#236 で 92→94）
};
